...
<link href="https://kit-pro.fontawesome.com/releases/v5.15.1/css/pro.min.css" rel="stylesheet">
  ...
  <div class="qna">
       ...
       <div class="item_section">
            <form action="itemsQnAUpdate" method="get" id="itemsQnAUpdate">
                <table>
                    ...
                    <tr style="border: none;">
                        <td colspan="2">
                            <select name="items_qna_title">
                            	<option value="${ items_qna_dto.items_qna_title }">${ items_qna_dto.items_qna_title }</option>
                    ...
                    <tr>
                        <th>이름</th>
                        <td>
                            <input type="text" value="${ items_qna_dto.items_qna_name }" name="items_qna_name" style="border: solid 1px #c0c0c0; width: 250px; height: 30px; font-weight: normal; padding: 0 5px;">
                        </td>
                    </tr>
                    <tr>
                        <th>비밀번호</th>
                        <td>
                            <input type="password" value="${ items_qna_dto.items_qna_password }" name="items_qna_password" style="border: solid 1px #c0c0c0; width: 250px; height: 30px; font-weight: normal; padding: 0 5px;">
                        </td>
                    </tr>
                    <tr>
                        <th>비밀글설정</th>
                    ...
                    <tr style="border-bottom: solid 1px #d4a5a5;">
                        <td colspan="2" >
                            <textarea name="items_qna_content" id="" cols="30" rows="10" style="font-weight: normal; padding: 10px;">${ items_qna_dto.items_qna_title }</textarea>
                        </td>
                    </tr>
            ...
            <table>
             <tr>
                        ...
                        <td style="display: flex; justify-content: end;">
                            <button type="submit" id="qna_submit" form="itemsQnAUpdate">등록</button>
