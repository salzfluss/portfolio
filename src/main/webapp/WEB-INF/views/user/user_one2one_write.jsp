...
<link rel="stylesheet" href="/css/user/user_one2one_write.css">
		...
		<input type="hidden" name="one2one_img" value="imagelink" />
			<table>
				<tr>
					...
					<input type="text" class="form-control" id="exampleFormControlInput1title" name="one2one_title" placeholder="글 제목을 입력하세요" />
					</td>
				...
				<input type="text" class="form-control" id="exampleFormControlInput1" name="one2one_pw" placeholder="4자리 숫자" onKeyup="this.value=this.value.replace(/[^0-9]/g,'');" maxlength='4' />
				</td>
  ...
  <div class='bigPictureWrapper'>
	...
	function checkValue() {
  		...
  		if(document.getElementById( 'exampleFormControlInput1title' ).value == '') { //empty: null, 길이 0
  			alert("제목을 입력해주세요");
  			//document.getElementById('one2one_reply_title').focus();
  			return false; //submit전송이 안됨
  		}
