                ...
                <table>
                    ...
                    <tbody class="myinfo_body">
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" class="MS_input_txt" name="member_email" id="member_email" value="${memberDto.member_email }">
...
// 이메일 중복 확인
    function emailCheck() {
        ...
        $.ajax({
        url : 'http://localhost:8090/my_info_change/emailCheckAjax?member_email='+member_email,
            type : 'get',
