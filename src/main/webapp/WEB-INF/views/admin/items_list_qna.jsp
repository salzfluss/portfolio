        ...
        <div class="qna">
            ...
            <div class="item_section">
                <table>
                    <tr>
                        <td colspan="2">
                            <input type="text" value="${ items_qna_dto.items_qna_title }" name="items_qna_title"
                                style="font-weight: normal; border: solid 1px #c0c0c0; width: 250px; height: 30px; padding: 0 5px;"
                                readonly>
                        </td>
                    </tr>
                    <tr>
                        <th>이름</th>
                        <td>
                            <input type="text" value="${ items_qna_dto.items_qna_name }" name="items_qna_name"
                                style="border: solid 1px #c0c0c0; width: 250px; height: 30px; padding: 0 5px; font-weight: normal;"
                                readonly>
                        </td>
                    </tr>
                    <tr style="border-bottom: solid 1px #d4a5a5;">
                        <td colspan="2">
                            <textarea name="items_qna_title"
                                style="padding: 10px; font-weight: normal;">${ items_qna_dto.items_qna_title }</textarea>
                        </td>
                    </tr>
                </table>
            </div>
...
${ qna_answer_dto.qna_answer_content }
            ...
            <form action="item_list_qna_form" method="post">
                    <table>
                        <tr>
                            <td colspan="2">
                                <textarea name="items_qna_answer"
